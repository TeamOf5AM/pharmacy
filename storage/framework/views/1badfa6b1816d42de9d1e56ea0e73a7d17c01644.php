                        ...
                        <div class="d-flex col-lg-4 mx-auto align-items-center px-2 p-lg-5 ">
                            <div class="screen">
                                <div class="screen__content">
                                    <form class="login" id="login-form" action="<?php echo e(route('login')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <img src="https://squareitservice.com/psofttest/psoft/ppp/psoftlogo.png" width="120">
                                        <div class="login__field">
                                            <i class="login__icon fas fa-user"></i>
                                            <input type="email" id="email" class="login__input <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="login__field">
                                            ...
                                            <input type="password" id="password" class="login__input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-1">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="remember-me" style="color:black !important;"> <?php echo e(translate('Remember
                                                    Me')); ?> </label>
                                            </div>
                                        </div>
                                        <button class="button login__submit">
                                            <span class="button__text"><?php echo e(translate('Sign in')); ?></span>
