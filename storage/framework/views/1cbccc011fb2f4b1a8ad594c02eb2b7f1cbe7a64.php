<?php $__env->startSection('title', translate('Edit Dependent Member') ); ?>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title"><?php echo e(translate('Edit Dependent Member')); ?></h4>
                </div>
                <div class="card-body">
                  <form class="form" method="POST" action="<?php echo e(route('dependentMember.edit', $customer->id)); ?>">
                      <?php echo csrf_field(); ?>
                      <div class="box-body">
                        <div class="row">
                          <div class="col-md-6 col-12">
                            <fieldset>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                  <input type="text" class="form-control" value="<?php echo e($surname); ?>"  name="surname"  style="text-transform:uppercase" required>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                  <input type="text" class="form-control" value="<?php echo e($firstname); ?>"  name="firstname" style="text-transform:uppercase" required>
                                </div>
                              </div>
                              <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Pharmacy/resources/views/dependentmember/edit.blade.php ENDPATH**/ ?>