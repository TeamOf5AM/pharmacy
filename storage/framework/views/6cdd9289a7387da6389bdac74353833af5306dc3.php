...
<div class="table-responsive">
    <div id="invoice" class="row">
        ...
        <div class="action-button">
            <a href="<?php echo e(route('dashboard')); ?>" class="btn back-to-dashboard">
                Back to Dashboard
            </a>
            <a href="<?php echo e(url()->previous()); ?>" class="btn back-to-list">
                Back to list
            </a>
            ...
            <?php if($invoice->customer_id != 0): ?>
                <a href="<?php echo e(route('pos.send_invoice_to_email',$invoice->id)); ?>" class="btn send-to-email">
                    Send to email
                </a>
            <?php endif; ?>
        </div>
        ...
        <section style="width: 302px; margin: 10px auto;background-color: #fff; padding:5px" id="invoiceArea">
            ...
            <section style="font-size: 12px;  line-height: 1.222;">
                <table style="width: 100%;">
                    ...
                    <tr style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
                        <td class="w-30" style="font-size:12px"><span style="font-size:12px"><b>Invoice ID:</b></span></td>
                        <td style="font-size:12px"><?php echo e($invoice->inv_id); ?></td>
                    </tr>
                    <?php if($invoice->customer_id != 0): ?>
                        <tr style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Pharmacy/resources/views/invoice/print.blade.php ENDPATH**/ ?>