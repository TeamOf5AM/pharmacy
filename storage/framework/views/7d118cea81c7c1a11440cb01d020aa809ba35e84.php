                     ...
                     <div class="row">
                          <div class="col-md-4 col-12">
                              <div class="mb-1">
                                  ...
                                  <input type="text" id="first-name-column" class="form-control" placeholder="<?php echo e(__('pages.product_code')); ?>" name="product_code">
                              </div>
                          </div>
                          <div class="col-md-4 col-12">
                              <div class="mb-1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pharma/resources/views/medicine/add.blade.php ENDPATH**/ ?>