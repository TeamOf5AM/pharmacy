                  ...
                  <form class="form" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="row">
                         <div class="col-md-4 col-12">
                             <div class="mb-1">
                                 <label class="form-label" for="first-name-column"><?php echo e(__('pages.product_code')); ?></label>
                                 <input type="text" id="first-name-column" class="form-control" placeholder="<?php echo e(__('pages.product_code')); ?>" name="pr_code">
                             </div>
                         </div>
                          <div class="col-md-4 col-12">
                              <div class="mb-1">
                          ...
                          <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-column"><?php echo e(__('pages.nappie_code')); ?></label>
                                    <input type="text" id="first-name-column" class="form-control" placeholder="<?php echo e(__('pages.nappie_code')); ?>" name="nappie_code">
                                </div>
                            </div>
                          <div class="col-md-4 col-12">
                              <div class="mb-1">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="first-name-column"><?php echo e(__('pages.stock_type')); ?> <font color="red">*</font></label>
                                <select class="select2 form-select" id="select2-basic" data-select2-id="select2-basic" tabindex="-1" aria-hidden="true" name="stock_type" required>
                                    <option value=""><?php echo e(translate('Select Stock Type')); ?></option>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="first-name-column"><?php echo e(__('pages.discountable')); ?> <font color="red">*</font></label>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="first-name-column"><?php echo e(__('pages.bin_loc')); ?> <font color="red">*</font></label>
                          ...
                          <div class="col-md-4 col-12">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-column"><?php echo e(__('pages.long_desc')); ?> <font color="red">*</font></label>
                                    <input type="text" id="first-name-column" class="form-control" placeholder="<?php echo e(__('pages.long_desc')); ?>" name="long_desc" required>
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-column"><?php echo e(__('pages.short_desc')); ?></label>
                          ...
                          <div class="col-md-4 col-12">
                              <div class="mb-1">
                                  ...
                                  <select class="select2 form-select" id="select2-basic" data-select2-id="select2-basic" tabindex="-1" aria-hidden="true" name="category_id" required>
                                      <option value=""><?php echo e(translate('Select Department')); ?></option>
                          ...
                          <div class="col-md-4 col-12">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-column"><?php echo e(__('pages.brand')); ?> <font color="red">*</font></label>
                                    <input type="number" step="0.01" id="first-name-column" class="form-control" placeholder="<?php echo e(__('pages.brand')); ?>" name="brand" required>
                                </div>
                            </div>
                          <div class="col-md-4 col-12">
                              <div class="mb-1">
                                  <label class="form-label" for="first-name-column"><?php echo e(__('pages.max_disc')); ?> </label>
                                  <div class="input-group form-password-toggle mb-2">
                                      <input type="number" step="0.01" class="form-control" placeholder="<?php echo e(__('pages.max_disc')); ?>" name="max_disc" aria-describedby="basic-default-password">
                          ...
                          <div class="col-md-4 col-12">
                              <div class="mb-1">
                                  <label class="form-label" for="first-name-column"><?php echo e(__('pages.loy_disc')); ?> </label>
                                  <div class="input-group form-password-toggle mb-2">
                                      <input type="number" step="0.01" class="form-control" placeholder="<?php echo e(__('pages.loy_disc')); ?>" name="loy_disc" aria-describedby="basic-default-password">
                                      <span class="input-group-text cursor-pointer">%</span>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="col-md-4 col-12">
                              <div class="mb-1">
                                  <label class="form-label" for="first-name-column"><?php echo e(__('pages.discontinued')); ?> </label>
                                  <div class="demo-inline-spacing">
                                      <div class="form-check mt-1 form-check-inline">
                                          <input class="form-check-input" type="radio" name="status" id="inlineRadio1" value="1" >
                                          <label class="form-check-label" for="inlineRadio1"><?php echo e(translate('Yes')); ?></label>
                                      </div>
                                      <div class="form-check mt-1 form-check-inline">
                                          <input class="form-check-input" type="radio" name="status" id="inlineRadio2" value="0">
                                          <label class="form-check-label" for="inlineRadio2"><?php echo e(translate('No')); ?></label>
                                      </div>
                                  </div>
                              </div>
                          </div>
