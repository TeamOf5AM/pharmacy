<?php $__env->startSection('title', translate('Add Dependent Member')); ?>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title"><?php echo e(translate('Add Dependent Member')); ?></h4>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Pharmacy/resources/views/dependentMember/add.blade.php ENDPATH**/ ?>