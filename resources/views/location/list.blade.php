    ...
    <div class="card">
        <div class="card-body border-bottom">
            <h4 class="card-title">{{ __('pages.box_size') }}</h4>
                <div class="dt-action-buttons text-xl-end text-lg-start text-lg-end text-start "><div class="dt-buttons"><a class="dt-button btn btn-primary btn-add-record ms-2" tabindex="0" aria-controls="DataTables_Table_0" href="{{ route('leaf.add') }}"><span>{{ __('pages.leaf_add') }}</span></a> </div>
            </div>
        </div>
        <div class="mx-2 card-datatable table-responsive pt-0">
            <table class="user-list-table table">
                <thead class="table-light">
                    <tr>
                        <th>{{ __('pages.sn') }}</th>
                        <th>{{ __('pages.box_size') }}</th>
                        <th>{{ __('pages.rtl_inc') }}</th>
                        <th>{{ __('pages.qty_box') }}</th>
