            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">{{ __('pages.box_size') }}</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-12">
                        <div class="mb-1">
                          ...
                          <input type="text" id="first-name-column" class="form-control" placeholder="{{ __('pages.rtl_inc') }}" name="rtl_inc" required>
                        </div>
                      </div>
                      <div class="col-md-6 col-12">
                        <div class="mb-1">
                          <label class="form-label" for="first-name-column">{{ __('pages.avg_cost') }}</label>
                          <input type="text" id="first-name-column" class="form-control" placeholder="{{ __('pages.avg_cost') }}" name="avg_cost" required>
                        </div>
                      </div>
                      <div class="col-md-6 col-12">
                        <div class="mb-1">
                          <label class="form-label" for="first-name-column">{{ __('pages.cost') }}</label>
                          <input type="text" id="first-name-column" class="form-control" placeholder="{{ __('pages.cost') }}" name="cost" required>
                        </div>
                      </div>
