<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
    ...
    <li
        ...
        <li class="{{ active_if_full_match('medicines/location') }}"><a class="d-flex align-items-center"
            href="{{ route('location') }}"><i data-feather="circle"></i><span class="menu-item text-truncate"
            data-i18n="Add">{{ __('pages.bin_loc') }}</span></a>
        </li>
