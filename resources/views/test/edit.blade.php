@extends('layouts.app')
@section('title', translate('Edit Diagnosis & Tests') )
@section('content')
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">{{ translate('Edit Diagnosis & Tests')  }}</h4>
                </div>
                <div class="card-body">
                  <form class="form" method="POST" action="{{route('test.edit', $customer->id) }}">
                      @csrf
                    <div class="row">
                      <div class="col-md-6 col-12">
                       ...
                       <div class="col-md-6 col-12">
                        <div class="mb-1">
                          ...
                          <input type="text" id="first-name-column" class="form-control" placeholder="{{ translate('Center') }}" value="{{ $customer->center}}" name="center" required>
                        </div>
                      </div>
                      <div class="col-12">
