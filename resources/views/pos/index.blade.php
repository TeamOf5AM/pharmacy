...
<main id="content" role="main" class="main pointer-event">
                    ...
                    <div class="row mb-2 category-slider">
                        @foreach ($categories as $item)
                            <label for="category{{$item->id}}"
                                ...
                                <input class="d-none" id="category{{$item->id}}"
                                       type="radio"
                                       value="{{$item->id}}"
                                       name="category"
                        ...
                        <div class="col-12 col-sm-12 col-md-4 col-lg-3 px-1 my-2 my-lg-0">
                            <div class="input-group float-right">
                                ...
                                >
                                    ...
                                    @foreach ($vendors as $vdrItem)
                                        <option value="{{$vdrItem->id}}" {{$vendor == $vdrItem->id?'selected':''}}>{{$vdrItem->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-lg-3 text-right">
                                    <div class="d-flex align-items-center justify-content-end">
                                        ...
                                        <a href="{{ route('dashboard') }}" class="btn btn-primary rounded mx-2 mr-4"
                                           type="button"
                                        ...
                                        <div class="dropdown user-profile-button">
                                            ...
                                            <div class="dropdown-menu"
                                                ...
                                                <a class="dropdown-item" href="{{ route('sell.index') }}">
                                                    <i class="tio-shopping-basket"></i> Purchase
                                                </a>
                                                <a class="dropdown-item"
                                                   href="{{ route('invoice.reports') }}">
    ...
    @if($order)
        ...
        {{--                    </div>--}}
        {{--                    <div class="row pvl9" id="printableArea">--}}
        {{--                        @include('pos.order.invoice')--}}
        {{--                    </div>--}}
    ...
    <div class="modal fade" id="paymentModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content pvl14">
                <div class="modal-header">
                    <h3 class="modal-title">{{\App\CPU\translate('payment')}}</h3>
