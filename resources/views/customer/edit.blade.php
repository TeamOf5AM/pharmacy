          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form class="form" method="POST" action="{{route('customer.edit', $customer->id) }}">
                      @csrf
                    <div class="row">
                      ...
                      <div class="col-md-6 col-12">
                        <div class="mb-1">
                          ...
                          <input type="email" id="last-name-column" class="form-control" placeholder="Email" name="email" value="{{ $customer->email}}" required>
                        </div>
                      </div>
                      <div class="col-md-6 col-12">
                        <div class="mb-1">
                      ...
                      <div class="col-md-6 col-12">
                        <div class="mb-1">
                          <label class="form-label" for="country-floating">{{ __('pages.due') }}</label>
                          <input type="number" step="0.01" id="country-floating" class="form-control" name="due" placeholder="{{ __('pages.due') }}" value="{{ $customer->due}}">
                        </div>
                      </div>
                      <div class="col-12">
