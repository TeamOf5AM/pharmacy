    ...
    <div class="row mt-3 statrow fourboxstat">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box mx-auto rounded-circle bg-info">
                ...
                <a href="{{ route('instock') }}" class="small-box-footer bg-transparent">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box mx-auto rounded-circle bg-success">
                ...
                <a href="{{ route('invoice.reports') }}" class="small-box-footer bg-transparent">
                    More info <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
        <div class="col-lg-3 col-6">
            <div class="small-box mx-auto rounded-circle bg-warning">
                ...
                <a href="{{ route('expired') }}" class="small-box-footer bg-transparent">
                    More info <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
        <div class="col-lg-3 col-6">
            <div class="small-box mx-auto rounded-circle bg-danger">
                ...
                <a href="{{ route('stockout') }}" class="small-box-footer bg-transparent">
                    More info <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
